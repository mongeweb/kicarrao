...
<meta name="description" content="Revenda <?php  $uri[0] = strtr($uri[0], "-", " "); $uri[0] = ucwords($uri[0]); echo $uri[0]; ?> <?php  $uri[2] = strtr($uri[2], "-", " ");  $uri[2] = ucwords($uri[2]); echo $uri[2]; ?> " /></title>
...
<meta content='Revenda <?php  $uri[0] = strtr($uri[0], "-", " "); $uri[0] = ucwords($uri[0]); echo $uri[0]; ?> <?php  $uri[2] = strtr($uri[2], "-", " ");  $uri[2] = ucwords($uri[2]); echo $uri[2]; ?>' property='og:title' />
