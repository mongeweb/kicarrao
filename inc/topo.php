...
{
    if($("input.buscarTetxoTopo").val() == '')
    {
        $('.buscarTetxoTopo').val('Procurar');
    }
    $("input.buscarTetxoTopo")
		.focus(function(){
...
<div class="topo">
    <div class="topoinside">
        ...
        ?>
        <div class="logo"><a href="<?=$link;?>"><img src="<?=ssl().PROJECT_URL;?>/img/logo.png" alt="Kicarrão" /></a></div>
        <div class="buscabloco">
            ...
            <form name="buscaform" id="buscaform" method="get" action="<?=$link;?>">
                <div class="buscainput">
                    <input type="text" class="buscarTetxoTopo" name="q" id="buscar" title="Buscar" value="<?=$qTopo;?>" />
