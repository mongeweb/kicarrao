...
$codigo_barras = "$codigobanco.$nummoeda.$dv.$fator_vencimento.$valor.$campo_livre_com_dv";
...
{
  if ($data != "" && $data != "CONTRA-APRESENTAÇÃO" && $data != "À VISTA")
  {
	$data = explode("/",$data);
	$ano = $data[2];
	$mes = $data[1];
	$dia = $data[0];
    //echo abs((_dateToDays("1997","10","07")) - (_dateToDays($ano, $mes, $dia)));
