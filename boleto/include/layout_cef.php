...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        div.linksTopo
        {
            background:url("<?=sslRedir().PROJECT_URL;?>/img/fundoimprimir.png") no-repeat;
            color:#FFF;
    ...
    <body text='#000000' bgcolor='#ffffff' topmargin='0' rightmargin='0'>
        ...
        ?>
            <div style="width: 666px; text-align: center;">
                <div class="linksTopo">
                    <a href="<?=$link;?>">Meus anúncios</a>
                </div>
                <div class="linksTopo">
        ...
        <table cellspacing='0' cellpadding='0' width='666' border='0'>
            <tr>
                <td class='cp' width='150'> 
                    <span class="campo"><img src="imagens/logocaixa.jpg" width="150" height="40" border='0'></span>
                </td>
                ...
                <td class='cpt' width='58' valign='bottom'>
                    <div align='center'>
                        <font class='bc'><?=$dadosboleto["codigo_banco_com_dv"];?></font>
                    </div>
                </td>
                <td width='3' valign='bottom'>
                    <img height='22' src='imagens/3.png' width='2' border='0'>
                ...
                <td class='ld' align='right' width='453' valign='bottom'>
                    <span class=ld><span class="campotitulo"><?=$dadosboleto["linha_digitavel"];?></span></span>
                </td>
            </tr>
            <tr>
                <td colspan=5>
