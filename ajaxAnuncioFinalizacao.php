...
if($codCliente > 0)
{
    if($codAnuncio > 0)
    {
        if($acao != '')
        {
        	...
        	$valor = isset($_SESSION['planoValorPagamento']) ? $_SESSION['planoValorPagamento'] : 0;//4.50;
        	...
        	if($valor > 0)
            {
            	...
            	switch($acao)
            	{
            		...
            		case 'debito':
                        ...
                        $xmlRequest->urlRetorno = "https://www.kicarrao.com.br/anuncio-confirmacao.php";
                        $retorno['url'] = "https://www.kicarrao.com.br/anuncio-confirmacao.php";
