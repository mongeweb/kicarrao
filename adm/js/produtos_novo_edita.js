        ...
        ,callback: function(cont)
        {
            ...
            if (ctnrArqs.children('div').size() <= 0) {
                for (var i = 1; i <= cont; i++) {
                    ctnrArqs.append('<div>'+
                                        '<div>'+
                                            '<label>Foto<span> '+i+'</span></label>'+
                                            '<input type="file" name="fotos[]" id="foto'+i+'" title="Foto '+i+'">'+
                                        '</div>'+
                                        '<div>'+
            ...
            if (ctnrArqs.children('div').size() > 0) {
                if (qtdDivs > cont) {
                    ...
                    for (var i = ctnrArqs.children('div').size(); i < cont; i++) {
                        ctnrArqs.append('<div>'+
                                            '<div>'+
                                                '<label>Foto<span> '+(i+1)+'</span></label>'+
                                                '<input type="file" name="fotos[]" id="foto'+(i+1)+'" title="Foto '+(i+1)+'">'+
                                            '</div>'+
                                            '<div>'+
