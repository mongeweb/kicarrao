$(document).ready(function()
{
    ...
    $('input#numFotos').val(Contador . init(1, 1, 20))
        .keyup(function()
        {
            ...
            window.mg_dalay = window.setTimeout(function(){
                ...
                adicionarInputs($('div#groupDivs').get(0), Contador . contador, 'Foto ', 'file', 'file[]', 2, 'Legenda ', 'text', 'legenda[]');
            }, 700);
        });
    adicionarInputs($('div#groupDivs').get(0), Contador . contador, 'Foto ', 'file', 'file[]', 2, 'Legenda ', 'text', 'legenda[]');
    ...
    $('#maisFotos').click(function()
    {
        ...
        adicionarInputs($('div#groupDivs').get(0), num, 'Foto ', 'file', 'file[]', 2, 'Legenda ', 'text', 'legenda[]');
	});
