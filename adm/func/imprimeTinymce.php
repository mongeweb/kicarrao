 ...
 * @return void
 */
function imprimeTinymce($name = 'texto', $value = '', $width = 545, $height = 500, $title = '')
{
?>
    <!-- TinyMCE -->
    ...
    <script type="text/javascript">
    	tinyMCE.init({
    		...
    		width: <?=$width;?>,
    		height: <?=$height;?>,
    		plugins : "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,inlinepopups,insertdatetime,preview,searchreplace,print,contextmenu,paste,directionality,noneditable,visualchars,nonbreaking,xhtmlxtras,template,wordcount,advlist",
    ...
    <textarea title="<?=$title;?>" id="<?=$name;?>" name="<?=$name;?>" rows="15" cols="80" style="width: <?=$width;?>px; height: <?=$height;?>px"><?=$value;?></textarea>
<?php
}
?>
