...
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
        $resultado = mysql_query("SELECT * FROM veiculosMarcas ORDER BY marca");
        ...
        if ($linhas>0)
        {
        	for($n=0;$n<$linhas;$n++)
        	{
        		...
        		?>
                <td align="center">
                    <a href="http://<?=ADMIN_URL;?>/principal.php?id=7&subid=3&cod=<?=$tupla['cod'];?>" class="botaoDourado">&nbsp;Editar&nbsp;</a>
                </td>
        		<?
        		echo "</tr>";
        	}
