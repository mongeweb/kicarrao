...
if($submit != '')
{
    ...
    if($erro == 0)
    {
        ...
        $sql = "INSERT INTO veiculosVersoes (codModelo, versao, anos, anoIni, anoFim)
                VALUES(
                '{$modelo}', '{$versao}', '{$anos}', '{$anoIni}', '{$anoFim}');";
        ...
        else
    	{
    		...
    		echo " location.replace('http://".ADMIN_URL."/principal.php?id=9&subid=2'); \n";
    		echo " </script>";
            die();
    	}
    }
