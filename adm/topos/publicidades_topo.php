<tr>
    <td>
    	<table width="100%" cellpadding="0" border="0" cellspacing="0">
            <tr>
            	<td width="140" height="60" align="center" valign="middle" class="topo_lista_branco" bgcolor="#666666">PUBLICIDADES</td>
            ...
            <tr>
            	<td align="right">
                    ...
                    {
						?>
						<a href="http://<?=ADMIN_URL;?>/principal.php?id=11&subid=2">
                ...
                {
					?>
					<a href="http://<?=ADMIN_URL;?>/principal.php?id=11&subid=1">
