<?php
function propostaEmail($emailRemetente = 'email@dominio.com', $emailDestinatario = 'email@dominio.com', $emailResposta = 'email@dominio.com', $assunto = '', $nomeRemetente = '', $conteudoEmail = array(), $twitter = '', $facebook = '')
{
    require_once "mailer/class.phpmailer.php";
    $retorno = true;
    
    $nomeRev = array_key_exists('nomeRev',$conteudoEmail) ? $conteudoEmail['nomeRev'] : '';
    ...
    $proposta = array_key_exists('proposta',$conteudoEmail) ? $conteudoEmail['proposta'] : '';
                    ...
                    <div class='mestre' style='float: left; width:600px;'>
                        ...
                        <div class='centro' style='float: left; width:100%; min-height:362px;'>
                            <div style='font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#1A1A1A; margin-top:16px; margin-left:19px;'> 	
                                Prezado (a) $nomeRev<br />
                                Temos alguém interessado no seu veículo.<br />
                                Entre em contato com o interessado pelo e-mail $email
                            </div>
                            <div style='float: left; margin-left:14px; margin-right:14px;'>
                                <p style='background: url('http://www.kicarrao.com.br/img/padrao-email/fundotarja.png') no-repeat; width:559px; height:41px; color:#FFF; font-family:Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; line-height:41px; margin-top:24px; margin-bottom:0; padding-left:13px;'>
                                    Dados do interessado:
                                </p>
                                <div style='font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#1A1A1A; padding-top:28px; padding-left:19px;'>
                                    <b style='display:block; padding-bottom:5px;'>Nome: <span style='font-weight: normal;'>$nome</span></b>
                                    <b style='display:block; padding-bottom:5px;'>Fone: <span style='font-weight: normal;'>$fone</span></b>
                                    <b style='display:block; padding-bottom:5px;'>E-mail: <span style='font-weight: normal;'>$email</span></b>
                                    <b style='display:block; padding-bottom:5px;'>Proposta: <span style='font-weight: normal;'>$proposta</span></b>
                                </div>
